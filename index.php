...
alert('Error - ' + xhr.status + ': ' + xhr.statusText);
	...
	<h1>Pokemon Web Service</h1>
		<a href="year" class="category">Pokemon By Name</a><br/>
		<a href="box" class="category">Pokemon By Type</a><br/>
    <a href="year" class="category">Pokemon By Ability</a><br/>
		<a href="box" class="category">Pokemon By Height</a><br/>
    <a href="year" class="category">Pokemon By Weight</a><br/>
		<h3 id="filmtitle">This project will display </h3>
		<div id="films">
      <!--
      <div class = "film">
            <b>Film</b>: 1<br />
            ...
            <b>Writers</b>: Richard Maibaum, Johanna Harwood and Berkely MatherRichard Maibaum, Johanna Harwood and Berkely Mather<br />
